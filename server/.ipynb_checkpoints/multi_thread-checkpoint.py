...
alldata['2']=dict(nomor=2, nama="luke shaw", posisi="bek kiri Grup A")
...
alldata['6']=dict(nomor=6, nama="onga lunde", posisi="bek kiri Grup B")
...
if __name__=='__main__':
    try:
        ...
        logging.warning("Proses MultiThread Selesai")
